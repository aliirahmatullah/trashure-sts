                ...
                <tr class="transition hover:bg-gray-50">
                    ...
                    <td class="whitespace-nowrap px-6 py-3 text-center">
                        <div class="flex items-center justify-center gap-2">
                            {{-- Kembalikan --}}
                            <form action="{{ route('staff.transactions.restore', $trash->id_transaksi) }}" method="POST">
                                @csrf @method('PATCH')
                                <button type="submit"
                            ...
                            {{-- Hapus Permanen --}}
                            <form action="{{ route('staff.transactions.delete_permanent', $trash->id_transaksi) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
