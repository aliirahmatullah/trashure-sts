...
<div class="container mx-auto mt-4">
    ...
    <div class="mb-4 flex items-center justify-end">
        <a href="{{ route('admin.transactions.trash')}}" class="rounded-md bg-yellow-600 px-4 py-2 mr-2 text-sm font-medium text-white transition hover:bg-yellow-700">Data Sampah</a>
        <a href="{{ route('admin.transactions.export')}}" class="rounded-md bg-blue-600 px-4 py-2 mr-2 text-sm font-medium text-white transition hover:bg-blue-700mom">Export Data</a>
        <a href="{{ route('admin.transactions.create') }}" class="rounded-md bg-green-600 px-4 py-2 text-sm font-medium text-white hover:bg-green-700">
            Tambah Data
        </a>
    </div>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-3 text-center">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <form action="{{ route('admin.transactions.updateStatus', $key->id_transaksi) }}" method="POST" class="inline">
                                    @csrf @method('PATCH')
                                ...
                                {{-- Tombol Edit --}}
                                <a href="{{ route('admin.transactions.edit', $key->id_transaksi) }}" class="rounded-md bg-blue-600 px-3 py-1 text-xs font-medium text-white hover:bg-blue-700">Edit</a>

                                {{-- Tombol Hapus --}}
                                <form action="{{ route('admin.transactions.delete', $key->id_transaksi) }}" method="POST" class="inline">
                                    @csrf @method('DELETE')
