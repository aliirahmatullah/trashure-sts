...
<div class="container mx-auto mt-4">
    ...
    <div class="mb-4 flex items-center justify-end">
        ...
        <a href="{{ route('admin.waste-types.export')}}" class="rounded-md bg-blue-600 px-4 py-2 mr-2 text-sm font-medium text-white transition hover:bg-blue-700mom">Export Data</a>
